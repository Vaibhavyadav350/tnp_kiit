...
class _PersonalProjectState extends State<PersonalProject> {
  ...
  Widget build(BuildContext context) {
    return FormBuilder()
        ...
        .addTextField("Deployed Link", validatingCondition: fieldEquals("Live Project", true))
        .addTextField("Supporting Document Link",validatingCondition: fieldEquals("Have UserBase ?", true))
