...
class _AcademicAchievementsState extends State<AcademicAchievements> {
  ...
  TextEditingController _newAuthorEntryController = TextEditingController();
    ...
    return Padding(
      ...
      child: Padding(
        ...
        child: Column(children: [
          ...
          SizedBox(
              width: double.infinity,
              child: Text("Add Author Names", style: textAnnotation(context))),
          SizedBox(height: 20),
          SizedBox(
            width: double.infinity,
          ...
          SizedBox(height: 20),
          MatTextField(
              label: "Year of publication", controller: _formsList[index].yearController),
          SizedBox(height: 20),
          MatTextField(
              label: "URL (Journal or PDF)", controller: _formsList[index].urlController),
          SizedBox(height: 20),
          MatTextField(
